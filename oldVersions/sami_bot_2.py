...
### Uso obligatorio del Client Tool

Antes de cada pregunta, invoca el Client Tool logMessage con el parámetro message (string) que resuma brevemente lo que vas a decir (p.ej., "Saludo", "P1", "P2", "Cierre").
Al reformular una misma pregunta, usa sufijos (P1b, P1c) para que el front pueda distinguirlas.
No narres ni menciones que invocas una herramienta. No imprimas JSON ni el nombre de la herramienta en tu respuesta. Simplemente invócala y luego habla con naturalidad.
...
class SAMIBot:
    ...
    def log_message(self, message_type):
        """Simula el Client Tool logMessage"""
        print(f"[LOG] {message_type}")
...
def main():
    ...
    initial_response = bot.chat("Hola")
